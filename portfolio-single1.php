    ...
    <div class="nk-main">
                             ...
                             <!-- The slideshow -->
                                  <div class="carousel-inner">
                                    <div class="carousel-item active">
                                      <img class="img-fluid" src="images/img/bathroom-5.jpg" alt="Los Angeles">
                                    </div>
                                    <div class="carousel-item">
                                      <img class="img-fluid" src="images/img/bathroom-8.jpg" alt="Chicago">
                                    </div>
                                    <div class="carousel-item">
                                      <img class="img-fluid" src="images/img/bathroom-9.jpg" alt="New York">
                                    </div>
                                  </div>
            ...
            <div class="nk-pagination nk-pagination-center">
                <div class="container">
                    ...
                    <!-- <a class="nk-pagination-next" href="portfolio-single2.html"> -->
...
$(".nk-pagination-next").click(function(){
        ...
        window.location.href="portfolio-single2.php?id="+c;
});
